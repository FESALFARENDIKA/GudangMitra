# 📦 GudangMitra - Platform Dropshipping & Reseller Cerdas

[![Deploy](https://img.shields.io/badge/Live%20Demo-GitHub%20Pages-blue?style=for-the-badge)](https://username.github.io/GudangMitra)
...
### 🌐 Links
- **Source Code**: [GitHub Repository](https://github.com/username/GudangMitra)
- **Live Demo**: [https://username.github.io/GudangMitra](https://username.github.io/GudangMitra)
...
| 9 | 🛡️ Sistem Garansi (Escrow) | Keamanan transaksi dengan sistem escrow |
| 10 | ✅ Validasi Produk | Memastikan kualitas produk sebelum dijual ke reseller |

### 🆓 Tanpa Membership Wajib
Semua fitur dapat diakses tanpa biaya membership bulanan!
...
| CSS3 | Styling & animasi (Vanilla CSS) |
| JavaScript (ES6+) | Logika aplikasi |
| LocalStorage | Penyimpanan data lokal |
| GitHub Pages | Hosting & deployment gratis |
...
| F-04 | Login Gagal | Input email dan password salah | Muncul toast error | Toast error muncul "Email atau password salah!" | ✅ Pass |
...
| F-06 | Register Validasi Password | Input password != konfirmasi | Muncul toast error | Toast error "Password tidak cocok!" | ✅ Pass |
...
| F-10 | Supplier Ranking | Buka menu Ranking Supplier | Menampilkan daftar supplier terurut | 8 supplier tampil terurut by rating | ✅ Pass |
...
| F-12 | Submit Order | Klik Submit Order setelah validasi | Toast sukses muncul | Toast "Order berhasil divalidasi" | ✅ Pass |
| F-13 | Analisis Margin | Buka menu Analisis Margin | Tabel margin produk tampil | Tabel dengan 8 produk dan margin % | ✅ Pass |
...
|----|-------|--------|--------|-------|--------|
| P-01 | Page Load Time | First Contentful Paint | < 2s | ~0.5s (static HTML) | ✅ Pass |
| P-02 | File Size | Total assets | < 500KB | ~85KB (CSS+JS) | ✅ Pass |
| P-03 | Interactivity | Time to Interactive | < 3s | ~0.8s | ✅ Pass |
...
| S-04 | Data Protection | Password storage | Tersimpan di localStorage (demo only) | ⚠️ Demo |

### 6. Responsive Design Testing

| No | Breakpoint | Resolusi | Layout | Status |
|----|-----------|----------|--------|--------|
| R-01 | Desktop | 1200px+ | Full layout, sidebar + main | ✅ Pass |
| R-02 | Tablet | 768px - 1024px | Sidebar collapsed, grid adjustment | ✅ Pass |
| R-03 | Mobile | < 768px | Single column, hamburger menu | ✅ Pass |
...
- Design inspired by CheapShip UI
- Google Fonts (Inter, Poppins)
- Emoji icons for illustrations

---

**© 2026 GudangMitra. All rights reserved.**
